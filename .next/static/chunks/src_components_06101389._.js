...
;
;
const buttonVariants = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$class$2d$variance$2d$authority$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cva"])("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:scale-105 active:scale-100 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
    variants: {
        variant: {
...
"[project]/src/components/section-animator.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function SectionAnimator({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SectionAnimator.useEffect": ()=>{
            const observer = new IntersectionObserver({
                "SectionAnimator.useEffect": (entries)=>{
                    entries.forEach({
                        "SectionAnimator.useEffect": (entry)=>{
...
_s(SectionAnimator, "vRVZ8VjWDklRD4TrBfqZR50ZUu0=");
_c = SectionAnimator;
var _c;
__turbopack_context__.k.register(_c, "SectionAnimator");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
//# sourceMappingURL=src_components_06101389._.js.map